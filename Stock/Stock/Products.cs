...
namespace Stock
{
    public partial class Products : Form
    {
        ...
        {
            SqlConnection con = new SqlConnection(@"Data Source=PROG273\MSSQL2K17;Initial Catalog=Stock;Integrated Security=True");
            ...
            if (IfProductsExists(con, textBox1.Text))
            {
                ...
                SET [ProductName] = '" + textBox1.Text + "',[ProductStatus] = '" + status + "' WHERE [ProductCode] = '" + textBox1.Text + "'"; 
            }
            else
            {
